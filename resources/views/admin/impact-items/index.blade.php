...
@section('title', 'الأثر المتوقع')

@section('content')
<div class="flex justify-end mb-6">
    <a href="{{ route('admin.impact-items.create') }}" class="bg-primary hover:bg-primary-dark transition text-white font-bold px-6 py-2.5 rounded-xl">
        <i class="fa-solid fa-plus ms-1"></i> إضافة عنصر
    </a>
</div>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-3">
                            <a href="{{ route('admin.impact-items.edit', $item) }}" class="text-secondary hover:text-primary"><i class="fa-solid fa-pen"></i></a>
                            <form action="{{ route('admin.impact-items.destroy', $item) }}" method="POST" onsubmit="return confirm('تأكيد الحذف؟')">
                                @csrf @method('DELETE')
