...
<div class="grid md:grid-cols-2 gap-6">
    <div>
        <label class="block font-semibold text-gray-700 mb-2">السنة / المرحلة</label>
        <input type="text" name="year_label" value="{{ old('year_label', $item->year_label ?? '') }}" required placeholder="السنة الأولى"
